...
parser.add_argument('--archi', nargs='+', type = int, default = [10], metavar = 'A', help='architecture of the network')
parser.add_argument('--channels', nargs='+', type = int, default = [32, 64], metavar = 'C', help='channels of the convnet')
parser.add_argument('--kernels', nargs='+', type = int, default = [3, 3], metavar = 'K', help='kernels sizes of the convnet')
...
parser.add_argument('--epochs',type = int, default = 100,metavar = 'EPT',help='Number of epochs per tasks')
