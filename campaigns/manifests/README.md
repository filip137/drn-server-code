...
- for `mnist_relu_drn_reset_factorial.json`,
  `mnist_relu_drn_reset_differential_10ep.json`, and
  `mnist_relu_drn_four_vs_eight_common_window_10ep.json`, also place the
  frozen teacher at
