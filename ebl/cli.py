...
def _default_train_handler(request: TrainRequest) -> Optional[int]:
    if request.definition.experiment_id == "small_drn.v1":
        ...
        request.definition.experiment_id
        == "mnist_ibm_om_corrupt_source_hwa_cross_array_pulse_adam.v1"
    ):
        ...
        request.definition.experiment_id
        == "mnist_ibm_om_corrupt_multi_source_hwa_tuned_recovery.v1"
    ):
        ...
        request.definition.experiment_id
        == "mnist_ibm_om_exact_p0_structured_partial_pv_adam.v1"
    ):
        ...
        request.definition.experiment_id
        == "mnist_ibm_om_exact_p0_hybrid_fraction_pv_adam.v1"
    ):
        ...
        request.definition.experiment_id
        == "mnist_ibm_om_exact_p0_hybrid_extension_pv_adam.v1"
    ):
