#!/usr/bin/env python3
"""Collect Conv1 perfect-diode input-gain-40 LR sweep results."""
...
ROOT = Path(
    ...
    "mnist_bp_conv1_perfect_diode_inputgain40_lr_sweep_seed0_50epoch"
)
RUNS = [
...
def _run_dir(root: Path, run_name: str, lr: float) -> Path:
    return root / f"lr_{_label_float(lr)}" / "perfect_diode" / run_name / "seed_0"
