#!/usr/bin/env python3
"""Report recalibrated Conv2 stride-1 sat30 repeats into current_state.md."""
...
START = "<!-- conv2-stride1-recalibrated-sat30-autoupdate:start -->"
END = "<!-- conv2-stride1-recalibrated-sat30-autoupdate:end -->"
ROOT = (
    REPO_ROOT
    / "results"
    / "mnist_bp_conv2_hardsigmoid_stride1_recalibrated_sat30_voff4_k6_seed0_30epoch"
)
...
RUNS = [
    ...
    },
    {
        ...
        "path": ROOT
        / "target_sat30"
        / "input_gain_2233p578125"
        / "lr_mult_0p5"
        / "lr_0p000322352727196"
        / "hard_sigmoid"
        / "mnist_bp_amp_v4_c1"
        / "seed_0"
        / "metrics.json",
...
def build_block() -> tuple[str, bool]:
    ...
    lines = [
        START,
        f"- Conv2 stride-1 hard-sigmoid repeats with stride-1 recalibrated sat30 input gains, launched locally in tmux `conv2_stride1_recal_sat30`, updated {now}.",
        "",
