...
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_ROOT}/results/mnist_bp_conv1_hardsigmoid_noamp_saturation_targets_seed0_10epoch_lr2}"
...
# Same initialized no-amplification Conv1 saturation targets as the baseline run,
# with every learning rate multiplied by 2.
run_job 0.10 10.2362 0.140677122 sat10
run_job 0.30 24.845 0.057959416 sat30
run_job 0.50 45.8423 0.031412046 sat50
run_job 0.70 67.3022 0.021396016 sat70
run_job 0.90 176.104 0.0081770088 sat90
