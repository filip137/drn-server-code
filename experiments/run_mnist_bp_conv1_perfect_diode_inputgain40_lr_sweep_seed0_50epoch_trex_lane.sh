...
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_ROOT}/results/mnist_bp_conv1_perfect_diode_inputgain40_lr_sweep_seed0_50epoch}"
DATASET_ROOT="${DATASET_ROOT:-/home/filip/server_code/data}"
DEVICE="${DEVICE:-cuda}"
...
run_job() {
  ...
  echo "[lane ${LANE_INDEX}/${NUM_LANES}] job=${index} ${run_name} perfect_diode input_gain=40 K=4 epochs=50 lr=${lr} output=${job_root}"
