...
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_ROOT}/results/mnist_bp_conv1_hardsigmoid_inputgain40_higher_lr_seed0_50epoch_trex}"
...
job_index=0
run_job "${job_index}" mnist_bp_amp_v1_c1 0.024
job_index=$((job_index + 1))
run_job "${job_index}" mnist_bp_amp_v1_c1 0.030
job_index=$((job_index + 1))
run_job "${job_index}" mnist_bp_amp_v1_c2 0.048
job_index=$((job_index + 1))
run_job "${job_index}" mnist_bp_amp_v1_c2 0.060
