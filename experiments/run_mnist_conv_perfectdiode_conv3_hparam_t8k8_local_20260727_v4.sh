...
source_root=/tmp/pd_conv3_lr_t8k8_20260727_source_v5
...
study_root=${repo_root}/results/perfectdiode_conv3_lr_t8k8_20260727_v5
...
source_archive=/tmp/pd_conv3_lr_t8k8_20260727_source_v5.tar.gz
data_root=/home/filip/server_code/data
plan=${repo_root}/docs/experiment_plans/perfectdiode-conv3-lr-ordinary-mnist-t8k8-20260727-v5.md
...
runner_path=${repo_root}/experiments/run_mnist_conv_perfectdiode_conv3_hparam_t8k8_local_20260727_v4.sh
...
remote_host=akib
remote_source_root=/home/filiposana/staged/pd_conv3_lr_t8k8_20260727_source_v5
...
remote_study_root=/home/filiposana/results/perfectdiode_conv3_lr_t8k8_20260727_v5
...
remote_source_archive=/home/filiposana/staged/pd_conv3_lr_t8k8_20260727_source_v5.tar.gz
...
validate_fixed_tk_main() {
  ...
  "${local_worker_common[@]}" \
    --surface-id conv3_baseline_v1_c1--adam \
    --validate-preflight-tk-gate >/dev/null
  "${local_worker_common[@]}" \
    --surface-id conv3_legacy_v4_c0p25--adam \
    --validate-preflight-tk-gate >/dev/null
}
...
validate_smoke_receipts() {
  ...
  "${local_worker_common[@]}" \
    --surface-id conv3_baseline_v1_c1--adam \
    --validate-preflight-canary >/dev/null
  "${remote_worker_common[@]}" \
    --surface-id conv3_ours_v4_c1--adam \
    --validate-preflight-canary >/dev/null
}
