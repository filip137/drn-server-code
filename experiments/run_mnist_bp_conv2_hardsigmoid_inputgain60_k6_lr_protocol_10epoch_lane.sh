...
run_job() {
  ...
  echo "[lane ${LANE_INDEX}/${NUM_LANES}] job=${index} ${run_name} input_gain=60 K=6 epochs=10 lr=${lr} output=${job_root}"
...
for lr in 0.012 0.018 0.024 0.030 0.036; do
  run_job "${job_index}" mnist_bp_amp_v1_c1 "${lr}"
  job_index=$((job_index + 1))
done

for lr in 0.006 0.009 0.012 0.018 0.024; do
...
for lr in 0.024 0.030 0.036 0.048 0.060 0.075; do
