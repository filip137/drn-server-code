...
<!-- experiment-id: perfectdiode-conv12-best-observed-confirmation-20260727-v1 -->
### Perfect-Diode Conv1/Conv2 Best-Observed Confirmation

- **Testing:** The historical Conv1 10-epoch and Conv2 20-epoch best-observed rho confirmation attempt, documented in [`docs/incident_reports/perfectdiode-conv12-multistage-launch-loop-20260727.md`](incident_reports/perfectdiode-conv12-multistage-launch-loop-20260727.md).
- **Where:** Historical attempt-01 through attempt-03 failure evidence and attempt-04 local/partial staging; this repair launched no job, and current scheduler state was not live-revalidated.
- **Status:** `blocked` — two historical pre-training canaries failed, production count is zero, and any new attempt requires a new user-approved plan and post-report decision.
