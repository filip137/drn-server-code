...
### AIHWKit sources not yet used by this repository
...
| --- | --- | --- |
| `ReRamArrayOMPresetDevice` | Normalized optimized-material 14 nm ReRAM-array model, nominally `[-1, 1]` | Not selectable by repository configuration; requires an explicit capability, provenance declaration, and tests before use |
| `ReRamArrayHfO2PresetDevice` | Normalized baseline-HfO2 14 nm ReRAM-array model, nominally `[-1, 1]` | Not selectable by repository configuration; requires an explicit capability, provenance declaration, and tests before use |
