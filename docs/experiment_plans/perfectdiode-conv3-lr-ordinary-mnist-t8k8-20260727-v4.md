# Perfect-Diode Conv3 Learning-Rate Screen at T=8, K=8 (Minimal Smoke)

This approved operational successor preserves the user-selected `T=8, K=8`
science and the complete upward 3x3 rho grid. It replaces v3's hardcoded
center-cell execution smoke with the smallest declared core cell,
`rho_conv=0.009, rho_dense=0.03`. The immutable v3 center-cell failure remains
valid negative diagnostic evidence and the center remains in the production
grid. Fresh manifest-bound residual and gradient audits at exactly `8/8` are
required for baseline, ours, and legacy before either lane may launch.

```json
{
  "schema_version": "experiment-run-plan/v1",
  "experiment_id": "perfectdiode-conv3-lr-ordinary-mnist-t8k8-20260727-v4",
  "title": "Perfect-Diode Conv3 Learning-Rate Screen at T=8, K=8 (Minimal Smoke)",
  ...
  "sweep": {
    "config_path": "results/perfectdiode_conv3_lr_t8k8_20260727_v4/study.resolved.json",
    "config_sha256": "810fffb9a30357b9ddba66d142e93b4db6eca8364964845832a2897e433c001d",
    "manifest_path": "results/perfectdiode_conv3_lr_t8k8_20260727_v4/surface_manifest.json",
    "manifest_sha256": "f11a50a1abdae5a81e9a96dbcca6e13d8cc6d62971283e6e37fe615c81a4c03d",
    ...
    "undeclared_fields_fixed_by": [
      ...
      "results/perfectdiode_conv3_lr_t8k8_20260727_v4/study.resolved.json",
      "results/perfectdiode_conv3_lr_t8k8_20260727_v4/surface_manifest.json"
    ]
  },
  "execution": {
    "launcher": [
      "/home/filip/server_code_conv_learning_rate_protocol/experiments/run_mnist_conv_perfectdiode_conv3_hparam_t8k8_local_20260727_v3.sh",
      "--dispatch"
    ],
    "collector": [
      "/home/filip/miniconda3/envs/py312/bin/python",
      "/tmp/pd_conv3_lr_t8k8_20260727_source_v4/experiments/run_mnist_conv_perfectdiode_hparam_v2_orchestration.py",
      "finalize-study",
      "--root",
      "/home/filip/server_code_conv_learning_rate_protocol/results/perfectdiode_conv3_lr_t8k8_20260727_v4"
    ],
    "validator": [
      "/home/filip/miniconda3/envs/py312/bin/python",
      "/tmp/pd_conv3_lr_t8k8_20260727_source_v4/experiments/run_mnist_conv_perfectdiode_hparam_v2_orchestration.py",
    ...
    "preflight": {
      ...
      "receipt_path": "results/perfectdiode_conv3_lr_t8k8_20260727_v4/preflight/scheduled-run-preflight.json"
    }
  },
  "storage": {
    "root_alias": "REPO_ROOT",
    "local_results_root": "results",
    "local_bundle_path": "results/perfectdiode_conv3_lr_t8k8_20260727_v4",
    "remote_staging": [
      {
        "host": "akibscomputer",
        "path": "/home/filiposana/results/perfectdiode_conv3_lr_t8k8_20260727_v4",
        "intended_local_destination": "results/perfectdiode_conv3_lr_t8k8_20260727_v4"
      }
    ]
  },
  "reporting": {
    ...
    "comparison_cards": [
      {
        "comparison_id": "perfectdiode-conv3-lr-ordinary-mnist-t8k8-20260727-v4",
        "card_schema_version": "drn-result-card/v1",
        "card_path": "result_registry/cards/diagnostics/perfectdiode-conv3-lr-ordinary-mnist-t8k8-20260727-v4.json",
        "review_path": "result_registry/reviews/perfectdiode-conv3-lr-ordinary-mnist-t8k8-20260727-v4.json",
        "final_results_anchor": "docs/results/index.md#perfectdiode-conv3-lr-ordinary-mnist-t8k8-20260727-v4"
      }
    ],
  ...
  "approval": {
    "status": "approved",
    "approved_by": "Filip",
    "approved_at": "2026-07-27T17:43:32+02:00",
    "amendment_of": "perfectdiode-conv3-lr-ordinary-mnist-t8k8-20260727-v3"
  }
}
```

The immutable execution source is commit
`7de08d39fc8150a21285c5b5a7e6be25f70a709e`, with source-archive SHA-256
`b07d074f3ea857add9ba00ba0c4ebd1e98a31eb860f0a2576e33fefe0ee99248`,
effective-code fingerprint
`64971d2e2765d52184f56fa60c59d441049b9e3f2db07611f1622eaf9681ed3c`,
worker SHA-256
`454a65a4ec39c88a4161fa3358d203d38d31f5a27c4a8315cb7d50482d3a2039`,
and runner SHA-256
`11257d0d34af8108401a78ec115d5db58268763211a01763ffee8ca5087283db`.
