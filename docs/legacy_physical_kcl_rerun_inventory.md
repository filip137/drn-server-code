...
| 6 | same clean centered-EqProp authority, Conv3 legacy logical case `5` in pack `2` | planned on `umg@v100` in the serialized remaining-Conv3 wave |
...
| 9 | Conv1/Conv3 noisy authority above, Conv3 legacy logical case `5` in pack `2` | planned on `umg@v100` in the serialized remaining-Conv3 wave |
...
| 16 | `perfectdiode-conv123-fixed-uniform-init-wmax-adam-10-30-30ep-seed0-20260814-v1/conv3/02_wmax_1em4_legacy_adam.json` | planned on `umg@v100` in the serialized remaining-Conv3 wave |
| 17 | `perfectdiode-conv123-fixed-uniform-init-wmax-adam-10-30-30ep-seed0-20260814-v1/conv3/05_wmax_5em4_legacy_adam.json` | planned on `umg@v100` in the serialized remaining-Conv3 wave |
| 18 | `perfectdiode-conv123-fixed-uniform-init-wmax-adam-10-30-30ep-seed0-20260814-v1/conv3/08_wmax_1em3_legacy_adam.json` | planned on `umg@v100` in the serialized remaining-Conv3 wave |
