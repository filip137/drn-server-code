...
| 16 | `perfectdiode-conv123-fixed-uniform-init-wmax-adam-10-30-30ep-seed0-20260814-v1/conv3/02_wmax_1em4_legacy_adam.json` | running on `umg@v100` as `1399202` on `r8i5n8` since `2026-08-26 23:46:03 CEST`; both launch checks and every source/science/device guard passed, epoch 1 validation `81.86%` |
