...
| 8 | noisy centered-EqProp authority `perfectdiode_conv2_zero_bias_adam_eqprop_one_decade_sigma_5em4_ordinary_mnist_30ep_seed0_20260817_v1.json`, Conv2 legacy logical case `2` in pack `1` | running on `umg@v100` as `1416204` on `r7i0n5` since `2026-08-26 21:33:40 CEST`; injected beta `.03`, `T=K=6`, `sigma_v=5e-4`, both launch checks and every source/science/device guard passed, epoch 5 validation `94.16%` |
